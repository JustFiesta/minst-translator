...
UWAGA: Przed rozpoczęciem należy zainstalować menedżera pakietów \texttt{uv}.
Link do dokumentacji \texttt{uv} znajduje się pod linkiem: \url{https://docs.astral.sh/uv/getting-started/installation/}.
...
\begin{enumerate}
    ...
    \item Utwórz katalog docelowy \texttt{data/raw/} i umieść w nim pobrane pliki:
\end{enumerate}
